...
parser.add_argument('--style_thresh', type=float, default=0.7,
                    help='threshold for style intensity in style-aware selective sampling')
...
for epoch in range(0, steps+1):
    ...
    style_intensity = torch.cosine_similarity(image_features, text_direction, dim=1)
    loss_temp[style_intensity>args.style_thresh] =0
